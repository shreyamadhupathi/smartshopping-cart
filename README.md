...
- Run the Sql Query From this file: C:\Users\USER\Desktop\revshop\Shopsmart Systems
...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/shreyamadhupathi/smartshopping-cart.git```> Select master Branch > Next > Next > Finish.
