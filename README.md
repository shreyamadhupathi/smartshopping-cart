...
Step 2: Click On File > Import > Git > Projects From Git > Clone Url > Paste The Repository Url as: ```https://github.com/shreyamadhupathi/smartshopping-cart.git  ```> Select master Branch > Next > Next > Finish.
